...
$site->query("DELETE FROM `media` WHERE `mediaimageid` IS NOT NULL");
$site->query("DELETE FROM `seen_in`");
$site->query("DELETE FROM `moneysaving_article`");
$site->query("DELETE FROM `articles`");
$site->query("DELETE FROM `articlecategory`");
...
$site->query("DELETE FROM `image`");
$site->query("DELETE FROM `visitor`");

$site->query("ALTER TABLE `media` AUTO_INCREMENT=1");
$site->query("ALTER TABLE `seen_in` AUTO_INCREMENT=1");
$site->query("ALTER TABLE `moneysaving_article` AUTO_INCREMENT=1");
$site->query("ALTER TABLE `articles` AUTO_INCREMENT=1");
$site->query("ALTER TABLE `articlecategory` AUTO_INCREMENT=1");
...
$site->query("ALTER TABLE `image` AUTO_INCREMENT=1");
