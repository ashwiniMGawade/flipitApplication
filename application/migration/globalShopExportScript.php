...
class GlobalShopExport {
	...
	protected  function exportShopsInExcel()
	{
		...
		if(! empty($this->_shopsData))
		{
			...
			Appplication_migration_commonMigrationFunctions::copyDirectory($pathToFile, UPLOAD_DATA_FOLDER_EXCEL_PATH.$key);
			Appplication_migration_commonMigrationFunctions::deleteDirectory($pathToFile);
