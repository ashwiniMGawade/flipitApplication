<?php
Doctrine_Manager::getInstance()->bindComponent('EmailCampain', 'doctrine_site');
 ...
 */
abstract class BaseEmailCampain extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('emailcampain');
        ...
        $this->hasColumn('send_at', 'string', null, array(
                'type' => 'datetime',
                'fixed' => false,
                'unsigned' => false,
                'primary' => false,
        ...
        $this->hasColumn('recipients', 'integer', null, array(
                'type' => 'integer',
                'fixed' => false,
                'unsigned' => false,
                'primary' => false,
