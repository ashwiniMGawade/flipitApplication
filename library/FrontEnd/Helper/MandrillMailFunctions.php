...
class FrontEnd_Helper_MandrillMailFunctions extends FrontEnd_Helper_viewHelper {
    ...
    public function sendConfirmationMail($visitoremailMail, $currentController)
    {
        $mailData = array(
            ...
            array('name'=>'bestRegards',
                'content'=>
                    $this->zendTranslate->translate('Dear visitor Kortingscode.nl,')
            ),
            array(
                'name'=> 'centerContent',
                'content'=>
                    $this->zendTranslate->translate('You are receiving this email because you have indicated to keep abreast of the best discount codes and actions Kortingscode.nl.:')
                   ."<br/>". $this->zendTranslate->translate('Met de volgende stap bevestig je dat je deze e-mail hebt ontvangen, klik daarvoor op onderstaande link:').
                    '<a href="'
                    ...
                    . '">'.$this->zendTranslate->translate('Klik hier om je e-mail adres te bevestigen').'</a>'
            ),
            array(
                'name'=> 'bottomContent',
                'content'=> $this->zendTranslate->translate('Thanks').',<br><br>'
                    . $this->zendTranslate->translate('Kortingscode.nl')
            ),
            array(
                'name'=> 'copyright',
                'content'=>$this->zendTranslate->translate('Copyright &copy; 2013').' '.$this->siteName.'. '
        ...
        self::sendTemplate(
                ...
                $mailData,
                $emailFrom,
                $this->zendTranslate->translate('Email confirmation'),
                $visitoremailMail,
                $this->zendTranslate->translate('Member'),
                $this->zendTranslate->translate('Email your confirmation')
        );
        return true;
    }
