...
class Shop extends \KC\Entity\Shop implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'permaLink', 'metaDescription', 'usergenratedcontent', 'notes', 'deepLink', 'deepLinkStatus', 'refUrl', 'actualUrl', 'affliateProgram', 'title', 'subTitle', 'overriteTitle', 'overriteSubtitle', 'overriteBrowserTitle', 'shopText', 'views', 'howToUse', 'Deliverytime', 'returnPolicy', 'freeDelivery', 'deliveryCost', 'status', 'offlineSicne', 'accoutManagerId', 'accountManagerName', 'contentManagerId', 'contentManagerName', 'screenshotId', 'keywordlink', 'deleted', 'created_at', 'updated_at', 'howtoTitle', 'howtoSubtitle', 'howtoMetaTitle', 'howtoMetaDescription', 'ideal', 'qShops', 'freeReturns', 'pickupPoints', 'mobileShop', 'service', 'serviceNumber', 'discussions', 'displayExtraProperties', 'showSignupOption', 'addtosearch', 'customHeader', 'totalviewcount', 'showSimliarShops', 'showChains', 'chainItemId', 'chainId', 'strictConfirmation', 'howToIntroductionText', 'brandingcss', 'lightboxsecondtext', 'lightboxfirsttext', 'howtoguideslug', 'code_alert_send_date', 'moretextforshop', 'howtoSubSubTitle', 'shopsViewedIds', 'shopAndOfferClickouts', 'lastSevendayClickouts', 'customtextposition', 'showcustomtext', 'customtext', 'logo', 'adminfevoriteshops', 'conversions', 'offer', 'offerNews', 'popularshop', 'articlestore', 'shopsofKeyword', 'categoryshops', 'relatedshops', 'howtochapter', 'viewcount', 'ballontext', 'shop', 'affliatenetwork', 'shopPage', 'howtousesmallimage', 'howtousebigimage', 'visitors', 'keywords', 'favoriteshops');
    }
