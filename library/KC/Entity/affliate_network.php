...
class affliate_network
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="KC\Entity\affliate_network", mappedBy="affliate_networks")
     */
    ...
    /**
     * @ORM\ManyToOne(targetEntity="KC\Entity\affliate_network", inversedBy="affliate_network")
