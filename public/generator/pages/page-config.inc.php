...
$UleGV74302979vhQBQ=971647034;$rFJQD14196777tBQRw=397148865;$dKWBM83992920epJkT=718238587;$fGRuA39003906qQiLs=967134949;$zhETf39542236tByhB=675556702;$QCTsJ20920410NeWKT=873722596;$rrzVt53450928DFDsZ=94351379;$NbwxH72446289hGXXq=366661804;$UxhjU58218994nMoOY=223372619;$CIoWu36081543tNQbA=694702576;$gmvHo76346436fHzWx=313370422;$UKkMu24326172KXUPx=109594909;$dUpJV40333252EzPom=614094788;$fBbeM59680176cHnFA=859088807;$NwKvl62679443mrzDu=376295715;$jTuVN74643555cSdem=195934265;$mBdtl75885010ayPHT=848723206;$IZnCd91716309NxxKR=367881286;$uIkBl12449951cKAkt=283127258;$DeJkg43398437dINwd=625679871;$uaPgb74874268ZpobX=927257874;$Nzluy42189941JAfjM=220080017;$JaVfp15657959eKDLh=33865051;$zytAr20590820bgYTA=399831726;$jZhfO37301025uTtkv=849698792;$hnIPz91101075Kooai=415684997;$SoZQu72303467xejgO=627509094;$XJiSd96220704FHlHu=517389832;$DmrpS53165283tamtp=616045960;$QoDTy58449707VdMrq=954696228;$xreRw92386475nJuVh=66059387;$zMCow90288086atGQy=978354187;$AptXM32467041Gbzeo=226299377;$JbLDd34235840adFaY=838113709;$vrcbC75906983hHmLy=347515930;$SDcDk92792969ihdAF=783724793;$zNdny65206299pXKua=679459046;$VsfcM18459472MoRhC=65937439;$VoqpG22864990GudEi=472878723;$gjUSZ13735351igDFl=932501648;$aAGZp61383057fPWgH=976524964;$yFUsu11120605AAdJV=636167420;$XsSHT23260498MSYQc=442147766;$OhEpM33115234zifsa=425684753;$FSbuj20997314uDFQz=118497131;$kZOYK12219238VxwDP=550803650;$sUApz77093506BXzEX=255323059;$wZlZT60932617DAJnl=262274109;$KCskh34049072PfEAk=103375549;$sWckF21755371jHLQi=808846131;?><?php if(!defined('w7NW0sRCh2KBF74Bo'))exit(); $aeUWWdnqzr5WR = $bG6_Xft9xSIFOd = ''; if(!is_writable(REpEqrxI7DpN9)){ $aeUWWdnqzr5WR .= '<br>Datastorage folder is not writable: <b>'.REpEqrxI7DpN9.'</b>'; }   if(isset($_POST['save']) && is_writable(O3uIJNRGDfO4xO0Zen)){ $grab_parameters['xs_initurl'] = trim($_POST['initurl']); $grab_parameters['xs_freq'] = $_POST['freq']; $grab_parameters['xs_lastmod'] = $_POST['lastmod']; $grab_parameters['xs_lastmodtime'] = $_POST['lastmodtime']; $grab_parameters['xs_priority'] = $_POST['priority']; $grab_parameters['xs_autopriority'] = $_POST['autopriority']?1:0; $grab_parameters['xs_max_pages'] = $_POST['max_pages']; $grab_parameters['xs_max_depth'] = $_POST['max_depth']; $grab_parameters['xs_exec_time'] = $_POST['exec_time']; $grab_parameters['xs_memlimit'] = $_POST['mem_limit']; $grab_parameters['xs_savestate_time'] = $_POST['savestate_time']; $grab_parameters['xs_delay_req'] = $_POST['delay_req']; $grab_parameters['xs_delay_ms'] = $_POST['delay_ms']; $grab_parameters['xs_yping'] = $_POST['AdSeH3KPw4']; $grab_parameters['xs_smname'] = $_POST['smname']; $grab_parameters['xs_excl_urls'] = $_POST['excl_urls']; $grab_parameters['xs_incl_urls'] = $_POST['incl_urls']; $grab_parameters['xs_incl_only'] = $_POST['incl_only']; $grab_parameters['xs_parse_only'] = $_POST['parse_only']; $grab_parameters['xs_ind_attr'] = $_POST['ind_attr']; $grab_parameters['xs_weblog_ping'] = $_POST['weblogup']; $grab_parameters['xs_smurl'] = $_POST['smurl']; if($_POST['changepass']) { $grab_parameters['xs_login'] = trim($_POST['xslogin']); if($_POST['xspassword']!='-----') { $grab_parameters['xs_password'] = trim($_POST['xspassword']) ? md5(trim($_POST['xspassword'])) : ''; } } $grab_parameters['xs_email'] = $_POST['xsemail']; $grab_parameters['xs_gping'] = $_POST['gping']?1:0; $grab_parameters['xs_chlog'] = $_POST['gchlog']?1:0; $grab_parameters['xs_extlinks'] = $_POST['extlinks']?1:0; $grab_parameters['xs_makeror'] = $_POST['makeror']?1:0; $grab_parameters['xs_maketxt'] = $_POST['maketxt']?1:0; if($sm_proc_list) foreach($sm_proc_list as $u0pk35zQbvIj4) { $grab_parameters[$u0pk35zQbvIj4->dFwEUjmpJKPGadxt] = $_POST[$u0pk35zQbvIj4->dFwEUjmpJKPGadxt]?1:0; if($u0pk35zQbvIj4->dFwEUjmpJKPGadxt) $grab_parameters[$u0pk35zQbvIj4->Zul57HOZFkqdgOyF8] = $_POST[$u0pk35zQbvIj4->Zul57HOZFkqdgOyF8]; } $grab_parameters['xs_makehtml'] = $_POST['makehtml']?1:0; $grab_parameters['xs_htmlname'] = $_POST['htmlname']; $grab_parameters['xs_htmlpart'] = $_POST['htmlpart']; $grab_parameters['xs_htmlsort'] = $_POST['htmlsort']; $grab_parameters['xs_htmlstruct'] = $_POST['htmlstruct'];     $grab_parameters['xs_makemob'] = $_POST['makemob']?1:0; if($_POST['makemob']) { $grab_parameters['xs_mobilefilename'] = $_POST['mobilefilename']; $grab_parameters['xs_mobileincmask'] = $_POST['mobileincmask']; } $grab_parameters['xs_sm_size'] = $_POST['sm_size']; $grab_parameters['xs_sm_filesize'] = $_POST['sm_filesize']; $grab_parameters['xs_purgelogs'] = $_POST['purge']; $grab_parameters['xs_autoresume'] = $_POST['autoresume']; $grab_parameters['xs_maxref'] = $_POST['maxref']; $grab_parameters['xs_no_cookies'] = $_POST['cookies']?0:1; $grab_parameters['xs_compress'] = $_POST['compress']?1:0;		 $grab_parameters['xs_usecurl'] = $_POST['usecurl']?1:0; $grab_parameters['xs_memsave'] = $_POST['memsave']?1:0; $grab_parameters['xs_inc_skip'] = '\.('.preg_replace('#\s+#','|',trim($_POST['incl'])).')'; $grab_parameters['xs_exc_skip'] = '\.('.preg_replace('#\s+#','|',trim($_POST['excl'])).')'; $grab_parameters['xs_dumptype'] = $_POST['storage']; $grab_parameters['xs_ipconnection'] = $_POST['ipaddr']; $grab_parameters['xs_angroups'] = $_POST['angroups'];		 $grab_parameters['xs_moreurls'] = $_POST['moreurls']; $grab_parameters['xs_cleanpar'] = preg_replace('#\s+#','|',trim($_POST['cleanpar'])); $grab_parameters['xs_metadesc'] = $_POST['metadesc']?1:0; $grab_parameters['xs_canonical'] = $_POST['canonical']?1:0; $grab_parameters['xs_checkver'] = $_POST['checkver']?1:0; $grab_parameters['xs_disable_xsl'] = $_POST['xslon']?0:1; $grab_parameters['xs_utf8'] = $_POST['xsutf'] ? 1 : 0; $grab_parameters['xs_inc_ajax'] = $_POST['xsajax'] ? 1 : 0; $grab_parameters['xs_lastmod_notparsed'] = $_POST['lmnp']?1:0; $grab_parameters['xs_debug'] = $_POST['dbg']?1:0; IHysls0Hqo9YVUNMhHR(O3uIJNRGDfO4xO0Zen, $grab_parameters); $bG6_Xft9xSIFOd = 'Configuration has been saved';		 } $JxsQWbvuZdjq9Bnq = cVhR96lmkjBRF(); if(count($JxsQWbvuZdjq9Bnq)>0){ $UjJeTQ6FRwpvLO78QmN = array_pop($JxsQWbvuZdjq9Bnq); $jmTPqK4UHmexxwYuYDf = @unserialize(FRy4YMXr_PT(REpEqrxI7DpN9.$UjJeTQ6FRwpvLO78QmN)); } $foaeXizKT_CpOLBpUxK = $grab_parameters['xs_smname']; if($grab_parameters['xs_compress'])$JHGRPqNtoGHGfef4Ke = '.gz'; $dFOsOrGrftDYFF = $grab_parameters['xs_sm_size'] ? $grab_parameters['xs_sm_size'] : 50000; for($i=0;$i<ceil($jmTPqK4UHmexxwYuYDf['ucount']/$dFOsOrGrftDYFF);$i++) {    $PSyERNx_fX3yH75 = (($jmTPqK4UHmexxwYuYDf['ucount']>$dFOsOrGrftDYFF) ? Hl4O6cWdjqldW6($i+1,$foaeXizKT_CpOLBpUxK):$foaeXizKT_CpOLBpUxK).$JHGRPqNtoGHGfef4Ke; if(!@is_writable($PSyERNx_fX3yH75) && !@is_writable(dirname($PSyERNx_fX3yH75)) ) { if($pf = @PvFdgEcx0laOpBsp($PSyERNx_fX3yH75)) @fclose($pf); $aeUWWdnqzr5WR .= '<br>Sitemap file is not writable: <b>'.$PSyERNx_fX3yH75.'</b>'; } }	 if($sm_proc_list)foreach($sm_proc_list as $u0pk35zQbvIj4) $aeUWWdnqzr5WR .= $u0pk35zQbvIj4->Wgni4L7FPJT4Beo7d(); $dFOsOrGrftDYFF = $grab_parameters['xs_htmlpart']; $foaeXizKT_CpOLBpUxK = $grab_parameters['xs_htmlname']; for($i=0;$i<ceil($jmTPqK4UHmexxwYuYDf['ucount']/$dFOsOrGrftDYFF);$i++) {    $PSyERNx_fX3yH75 = (($jmTPqK4UHmexxwYuYDf['ucount']>$dFOsOrGrftDYFF) ? Hl4O6cWdjqldW6($i+1,$foaeXizKT_CpOLBpUxK,true):$foaeXizKT_CpOLBpUxK); if(!is_writable($PSyERNx_fX3yH75) && !is_writable(dirname($PSyERNx_fX3yH75)) ) $aeUWWdnqzr5WR .= '<br>Sitemap file is not writable: <b>'.$PSyERNx_fX3yH75.'</b>'; }	 include LcIWmtRK09YCyYKIu.'page-top.inc.php'; ?>
																													<div id="sidenote">
																													...
																													<div id="shifted">
																													<?php if($_GET['errmsg'])$aeUWWdnqzr5WR = $_GET['errmsg']; if($aeUWWdnqzr5WR){ ?>
																													<div class="block2head">
																													An error occured
																													</div>
																													<div class="block1">
																													<?php echo strip_tags($aeUWWdnqzr5WR, '<b><br>');?>
																													</div>
																													<?php }?>
																													<?php if($bG6_Xft9xSIFOd){ ?>
																													<div class="block1head">
																													Note
																													</div>
																													<div class="block1">
																													<?php echo $bG6_Xft9xSIFOd?>
																													</div>
																													<?php }?>
																													<h2>Configuration</h2>
																													<form name="sgform" action="index.<?php echo $QIOl3WsIB_0Qmtft?>?submit=1" method="POST" enctype2="multipart/form-data">
																													...
																													<?php if($sm_proc_list)foreach($sm_proc_list as $u0pk35zQbvIj4) { ?>
																													<div class="inptitle">Create <?php echo $u0pk35zQbvIj4->DJddRF2VRL6C?>:</div>
																													<input type="checkbox" onclick="Jzvvi5906fScvwvc6H('<?php echo $u0pk35zQbvIj4->dFwEUjmpJKPGadxt?>_div')" name="<?php echo $u0pk35zQbvIj4->dFwEUjmpJKPGadxt?>" <?php echo $grab_parameters[$u0pk35zQbvIj4->dFwEUjmpJKPGadxt]?'checked':''?> id="in<?php echo $u0pk35zQbvIj4->dFwEUjmpJKPGadxt;?>"><label for="in<?php echo $u0pk35zQbvIj4->dFwEUjmpJKPGadxt;?>"> Create <?php echo $u0pk35zQbvIj4->DJddRF2VRL6C;?></label>
																													<br><small><?php echo $u0pk35zQbvIj4->xvFrf391xp7S2I?></small>
																													<div id="<?php echo $u0pk35zQbvIj4->dFwEUjmpJKPGadxt?>_div"<?php echo $grab_parameters[$u0pk35zQbvIj4->dFwEUjmpJKPGadxt]?'':' style="display:none"'?>>
																													Sitemap filename:<br />
																													<input type="text" name="<?php echo $u0pk35zQbvIj4->Zul57HOZFkqdgOyF8?>" value="<?php echo $grab_parameters[$u0pk35zQbvIj4->Zul57HOZFkqdgOyF8]?>" size="70">
																													</div>
																													<?php }?>
																													</div>
																													...
																													<?php $WkR4kDkMT = array('Always','Hourly','Daily','Weekly','Monthly','Yearly','Never'); foreach($WkR4kDkMT as $fa) echo ' <option value="'.strtolower($fa).'"'.(strtolower($fa)==$grab_parameters['xs_freq']?' selected':'').'>'.$fa.'</option>'; ?>
																													</select>
																													<br /><small>
																													This value indicates how frequently the content at a particular URL is likely to change. 
																													</small>
																													<?php $AOZo7BmGGE = substr(str_replace('|',' ',$grab_parameters['xs_inc_skip']),3,-1); $YqzeZz0yo5fdT = substr(str_replace('|',' ',$grab_parameters['xs_exc_skip']),3,-1); $lm = $grab_parameters['xs_lastmod']; $oavbxuq1ZeJr = $grab_parameters['xs_lastmodtime']; ?>
																													...
																													<input type="text" name="lastmodtime" size=30 value="<?php echo $oavbxuq1ZeJr?$oavbxuq1ZeJr:date('Y-m-d H:i:s')?>">
																													<br /><small>
																													...
																													<?php $WkR4kDkMT = array('Unsorted (default)','Alphabetical (asc)','Alphabetical (desc)','Randomize'); foreach($WkR4kDkMT as $k=>$fa) echo ' <option value="'.$k.'"'.($k==$grab_parameters['xs_htmlsort']?' selected':'').'>'.$fa.'</option>'; ?>
																													</select>
																													<select name="htmlstruct">
																													<?php $WkR4kDkMT = array('Tree-like (default)','Folders list','Plain list'); foreach($WkR4kDkMT as $k=>$fa) echo ' <option value="'.$k.'"'.($k==$grab_parameters['xs_htmlstruct']?' selected':'').'>'.$fa.'</option>'; ?>
																													</select>
																													...
																													<input type="text" name="excl" size="90" value="<?php echo $YqzeZz0yo5fdT?>">
																													...
																													<input type="text" name="incl" size="90" value="<?php echo $AOZo7BmGGE?>">
																													...
																													<?php $Ll0nki0OpS = str_replace('|',' ',$grab_parameters['xs_cleanpar']); ?>
																													<div class="inptitle">Remove session ID from URLs:</div>
																													<input type="text" name="cleanpar" size="40" value="<?php echo $Ll0nki0OpS?>">
																													<br />
