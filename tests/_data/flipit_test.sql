...
--
-- Host: localhost
-- Generation Time: Jul 09, 2015 at 11:05 AM
...
--
-- Table structure for table `shopExcelInformation`
--

CREATE TABLE IF NOT EXISTS `shopExcelInformation` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `totalShopsCount` bigint(20) DEFAULT NULL,
  `passCount` bigint(20) DEFAULT NULL,
  `failCount` bigint(20) DEFAULT NULL,
  `deleted` tinyint(1) DEFAULT '0' COMMENT '0-on ,1-off',
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
