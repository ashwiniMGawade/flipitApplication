<?php  //[STAMP] 9be8893f67f11a0046ed9153e4f2195e
...
trait WebTesterActions
{
     ...
     *
     *
     * @see \Helper\Web::haveInDatabasePDOSite()
     */
    public function haveInDatabasePDOSite($table, $arr) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('haveInDatabasePDOSite', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Web::haveInDatabasePDOUser()
     */
    public function haveInDatabasePDOUser($table, $arr) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('haveInDatabasePDOUser', func_get_args()));
    }
