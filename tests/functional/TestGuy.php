...
class TestGuy extends \Codeception\AbstractGuy
{
    ...
    * Conditional Assertion: Test won't be stopped on fail
    ...
    public function canSeeInTable($model, $values = null) {
        $this->scenario->addStep(new \Codeception\Step\ConditionalAssertion('seeInTable', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
    ...
    public function seeInTable($model, $values = null) {
        $this->scenario->addStep(new \Codeception\Step\Assertion('seeInTable', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
    ...
    * Conditional Assertion: Test won't be stopped on fail
    ...
    public function cantSeeInTable($model, $values = null) {
        $this->scenario->addStep(new \Codeception\Step\ConditionalAssertion('dontSeeInTable', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
    ...
    public function dontSeeInTable($model, $values = null) {
        $this->scenario->addStep(new \Codeception\Step\Assertion('dontSeeInTable', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
    ...
    public function grabFromTable($model, $column, $values = null) {
        $this->scenario->addStep(new \Codeception\Step\Action('grabFromTable', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
