<?php
Doctrine_Manager::getInstance()->bindComponent('PopularShop', 'doctrine_site');
 ...
 */
abstract class BasePopularShop extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('popular_shop');
