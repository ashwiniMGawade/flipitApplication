$(document).ready(function() {
    if($('#addImageForm').length>0) {
        validateForm();
    }
    if($('#splash-image-table').length>0) {
        $('#splash-image-table').dataTable({"bFilter": false, "bPaginate": false}).rowReordering({
