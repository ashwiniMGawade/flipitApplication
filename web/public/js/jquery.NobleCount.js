...
(function($) {
	...
	**********************************************************************************/
	$.fn.NobleCount.settings = {
		...
		prefixString : ""			//		remaining are stored as the attribute
	...
	**********************************************************************************/
	...
	function find_remaining(t_obj, max_char){
		var balcno = max_char - ($(t_obj).val()).length + __(" characters remaining");
		return balcno;
	}
	...
	**********************************************************************************/
	...
	function event_internals(t_obj, char_area, c_settings, max_char, init_disp) {
		...
		if (c_settings.cloak) {
			...
			char_area.text(c_settings.prefixString + char_rem);
		}
